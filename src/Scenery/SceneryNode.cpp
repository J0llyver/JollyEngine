...
SceneryNode* SceneryNode::getParent() { return parent; }

uint32_t SceneryNode::getManagedObjectId() const { return managedObjectId; }
...
void SceneryNode::createChild(const uint32_t objectId) { children.push_back(SceneryNode(objectId, this)); }

void SceneryNode::addChild(const SceneryNode &sceneryNode) { children.push_back(sceneryNode); }
